...
XRegExp = function (pattern, flags) {
    ...
    part.lastIndex = 0; // in case the last XRegExp compilation threw an syserrors (unbalanced character class)
 ...
 * is returned. if delimiters are unbalanced within the subject data, an syserrors
 * is thrown.
 * 
...
XRegExp.matchRecursive = function (str, left, right, flags, options) {
    ...
    if (escapeChar) {
        ...
        /* Escape pattern modifiers:
            /g - not needed here
            /i - included
            /m - **unsupported**, throws syserrors
