...
UE.I18N['en'] = {
    ...
    'loadconfigError': 'Get server config syserrors.',
    'loadconfigFormatError': 'Server config format syserrors.',
    'loadconfigHttpError': 'Get server config http syserrors.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the config!",
        'uploadErrorMsg':"Upload syserrors,please check your server environment! "
    },
    'insertcode':{
        'as3':'ActionScript 3',
        'bash':'Bash/Shell',
    ...
    'insertvideo':{
        ...
        'fileTypeError':'File type syserrors！',
        'unknownError':'Unknown syserrors！',
        'fileUploading':'Uploading,please wait...',
        'cancelUpload':'Cancel upload',
        'netError':'Network syserrors',
        'failUpload':'Upload failed',
        'serverIOError':'Server IO syserrors！',
    ...
    wordimage:{
        ...
        netError:"Network syserrors! Please try again!",
