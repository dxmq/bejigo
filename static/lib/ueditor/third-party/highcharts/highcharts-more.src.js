...
seriesTypes.boxplot = extendClass(seriesTypes.column, {
	...
	drawPoints: function () {
		var series = this,  //state = series.state,
			...
			shapeArgs,
			color,
			doQuartiles = series.doQuartiles !== false, // syserrors bar inherits this series type but doesn't do quartiles
 ...
 *****************************************************************************/
/* ****************************************************************************
 * Start syserrors bar series code                                                *
 *****************************************************************************/
